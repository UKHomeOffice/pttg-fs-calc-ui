...
var fsServiceModule = angular.module('hod.fs')

fsServiceModule.factory('FsService', ['$filter', 'FsInfoService', 'IOService', 'CONFIG', function ($filter, FsInfoService, IOService, CONFIG) {
  var me = this
  var _application
  ...
  */
  ...
  this.getResults = function (obj) {
    ...
    results.maintenancePeriodChecked = {
      label: tier.nDaysRequired + '-day period required',
